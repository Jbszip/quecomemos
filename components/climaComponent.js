...
export default function ClimaComponent() {
    ...
    if (data === undefined || data[0] === undefined) {
        ...
        return (
            <div className="p-4">
                <div className="flex justify-center items-center space-x-2">
                    <div role="status">
                        <svg aria-hidden="true" className="mr-2 w-8 h-8 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        return (
            <section>
                <div className="max-w-md px-8 py-4 mx-auto mt-10 mb-6 rounded-lg shadow-lg cards">
                    <div className="flex justify-center md:justify-center">
                        <img className="object-cover h-20 rounded-full" alt="Ícono clima" src={icono} />
                        <h2 className=" mx-5 text-2xl font-semibold  md:text-3xl self-center">{city}</h2>
                    </div>
                    <div className="grid grid-rows-2 grid-flow-col gap-2 content-center mt-3">
                        ...
                        <p className="row-span-1">Mín: {min}°</p>
                        <p className="row-span-1">Máx: {max}°</p>
                        <p className="row-span-1">Sensación térmica: {sensacion}°</p>
                        <p className="row-span-1">Humedad: {humedad}%</p>
                    </div>
                </div>
            </section>
        )
